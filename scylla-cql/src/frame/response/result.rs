...
use crate::frame::frame_errors::{
    ...
    RawRowsAndPagingStateResponseParseError, ResultMetadataLazyDeserializationError,
...
impl RawMetadataAndRawRows {
    ...
    fn metadata_deserializer(
        ...
        ResultMetadataLazyDeserializationError,
    > {
        move |buf| {
            let server_metadata = {
                let global_table_spec = global_tables_spec
            ...
            if server_metadata.col_count() != server_metadata.col_specs().len() {
                return Err(
                    ResultMetadataLazyDeserializationError::ColumnCountMismatch {
    ...
    pub fn deserialize_metadata(
        self,
    ) -> StdResult<DeserializedMetadataAndRawRows, ResultMetadataLazyDeserializationError> {
        ...
        let rows_count: usize = types::read_int_length(frame_slice.as_slice_mut())
            .map_err(ResultMetadataLazyDeserializationError::RowsCountParseError)?;
